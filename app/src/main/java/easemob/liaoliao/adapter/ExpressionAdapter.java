...
import static easemob.liaoliao.R.*;
...
public class ExpressionAdapter extends ArrayAdapter<String>{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if(convertView == null){
			convertView = View.inflate(getContext(), layout.row_expression, null);
		}
		
		ImageView imageView = (ImageView) convertView.findViewById(id.iv_expression);
