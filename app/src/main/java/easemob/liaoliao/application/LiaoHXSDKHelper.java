...
import easemob.liaoliao.Constant;
import easemob.liaoliao.HXSDKHelper;
import easemob.liaoliao.R;
import easemob.liaoliao.activity.ChatActivity;
import easemob.liaoliao.activity.MainActivity;
import easemob.liaoliao.domain.User;
import easemob.liaoliao.utils.CallReceiver;
import easemob.liaoliao.utils.CommonUtils;
import easemob.liaoliao.utils.HXNotifier;
import easemob.liaoliao.utils.HXSDKModel;

public class LiaoHXSDKHelper extends HXSDKHelper {

    private static final String TAG = "LiaoHXSDKHelper";
    ...
    protected HXSDKModel createModel() {
        return new LiaoHXSDKModel(appContext);
    }
        ...
        return new HXNotifier(){
            public synchronized void onNewMsg(final EMMessage message) {
                ...
                if (message.getChatType() == ChatType.Chat) {
                    ...
                    notNotifyIds = ((LiaoHXSDKModel) hxModel).getDisabledGroups();
                } else {
                    chatUsename = message.getTo();
                    notNotifyIds = ((LiaoHXSDKModel) hxModel).getDisabledIds();
                }
     ...
     */
    public LiaoHXSDKModel getModel(){
        return (LiaoHXSDKModel) hxModel;
    }
    ...
    public Map<String, User> getContactList() {
        if (getHXId() != null && contactList == null) {
            contactList = ((LiaoHXSDKModel) getModel()).getContactList();
        }
