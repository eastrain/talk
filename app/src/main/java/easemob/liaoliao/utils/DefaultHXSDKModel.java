...
public class DefaultHXSDKModel extends HXSDKModel{
    ...
    public void setSettingMsgNotification(boolean paramBoolean) {
        PreferencesUtils.getInstance(context).setSettingMsgNotification(paramBoolean);
    ...
    public boolean getSettingMsgNotification() {
        ...
        if(val == null){
            val = PreferencesUtils.getInstance(context).getSettingMsgNotification();
    ...
    public void setSettingMsgSound(boolean paramBoolean) {
        PreferencesUtils.getInstance(context).setSettingMsgSound(paramBoolean);
    ...
    public boolean getSettingMsgSound() {
        ...
        if(val == null){
            val = PreferencesUtils.getInstance(context).getSettingMsgSound();
    ...
    public void setSettingMsgVibrate(boolean paramBoolean) {
        PreferencesUtils.getInstance(context).setSettingMsgVibrate(paramBoolean);
    ...
    public boolean getSettingMsgVibrate() {
        ...
        if(val == null){
            val = PreferencesUtils.getInstance(context).getSettingMsgVibrate();
    ...
    public void setSettingMsgSpeaker(boolean paramBoolean) {
        PreferencesUtils.getInstance(context).setSettingMsgSpeaker(paramBoolean);
    ...
    public boolean getSettingMsgSpeaker() {        
        ...
        if(val == null){
            val = PreferencesUtils.getInstance(context).getSettingMsgSpeaker();
    ...
    public void allowChatroomOwnerLeave(boolean value){
        PreferencesUtils.getInstance(context).setSettingAllowChatroomOwnerLeave(value);
    }
    
    public boolean isChatroomOwnerLeaveAllowed(){
        return PreferencesUtils.getInstance(context).getSettingAllowChatroomOwnerLeave();
    }
